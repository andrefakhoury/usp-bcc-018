...
float quantos(char *pergunta, char **p, int n_comments, char **c){
    ...
    char *palavras_ruins[12] = {"detestei", "odiei", "ruim", "pessimo", "terrivel", "raiva", "odio", "pessima", "lento", "lenta", "fragil", "desisti"};
...
/*obs.: o programa está rodando perfeitamente no compilador gdb nos casos 1, 2 e 3. 
Já no 4, 5, 6 e 7, ele daria a resposta certa mas está dando um erro (corrupted size vs. prev_size ; Aborted (core dumped)) a partir de determinado momento. 
Nos casos 4 e 5 ele mostra até a 3ª saída corretamante. Nos casos 6 e no 7 ele roda a primeira saída e depois para.
*/
/*obs2.: no compilador gcc, ele dá problema (sysmalloc: Assertion). O caso 2 e 3 funcionam perfeitamente.
Já os casos 4, 5, 6 e 7 dão um problema relacionado à comparação (//compara o produto dos comentários com o produto pedido), que eu não sei corrigir.
*/