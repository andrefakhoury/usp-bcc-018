/**
 * Program that stores and recover data from binary and csv files.
...
void bin_searchReg() {
	char fileName[256]; // main file
	char fieldName[256], fieldValue[2048]; // field and value to search for
